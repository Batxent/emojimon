...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerAtPositon")));
bytes32 constant PlayerAtPositonTableId = _tableId;

library PlayerAtPositon {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayerAtPositon", _fieldNames);
  }
